  ...
  `),t("packs-grid",u,e=>`
    <article class="pack-card reveal">
      ...
      <ul class="pack-card__list">
        ${e.items.map(r=>`<li>${r}</li>`).join("")}
      </ul>
    </article>
  `)}function t(e,r,o){const s=document.getElementById(e);s&&(s.innerHTML=r.map(o).join(""))}function y(){const e=new IntersectionObserver(r=>{r.forEach(o=>{o.isIntersecting&&(o.target.classList.add("is-visible"),e.unobserve(o.target))})},{threshold:.15,rootMargin:"0px 0px -40px 0px"});document.querySelectorAll(".reveal").forEach(r=>e.observe(r))}function f(){const e=document.querySelector(".site-header");e&&window.addEventListener("scroll",()=>{e.classList.toggle("site-header--scrolled",window.scrollY>24)})}document.addEventListener("DOMContentLoaded",()=>{m(),y(),f()});
